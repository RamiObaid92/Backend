...
public class MemberService(IMemberRepository memberRepository, ICacheHandler<IEnumerable<MemberModel>> cacheHandler, IFileHandler fileHandler) : IMemberService
{
